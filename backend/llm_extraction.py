...
systemPrompt = """
    You are an LLM that specializes in converting natural language queries to iDigBio queries in ElasticSearch 2.4 query string format. 
...
try:
    ...
    initial_response = generate_query("Fetch all the galax urceolata or Galaxia collected in the united states.").model_dump(exclude_none=True)
